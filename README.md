...
|---|---|----------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Week 1:**<br>9/24–9/30 | Read up on Aho–Corasick and get a basic grasp of multi-pattern searching, tries, and failure links. | Look at related string-matching algorithms like Naive Search, KMP, and Rabin–Karp. Split the research among group members. Proposal submission due 9/25. |
